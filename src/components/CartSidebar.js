...
import { getProductStockQuantity, normalizeProductImages } from '../utils/productImages.js';
          ...
          <>
            <div className="cart-items">
              {items.map((item, index) => {
                const stockQuantity = getProductStockQuantity(item);
                const isMaxedOut = stockQuantity !== null && item.quantity >= stockQuantity;
